...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <div class="container">
            <h2>Nuevo Juguete</h2>
            <form method="post"  action="ServletPOSTJugueteNuevo">
            ...
            <input type="text" class="form-control" placeholder="Ruta Imagen" name="ruta">
          ...
          <script>
            ...
            var confirmacion = confirm("Desea agregar este Juguete");
            if (confirmacion) {
